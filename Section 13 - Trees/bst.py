...
# Print the value of the root node and its immediate children
...
# Check if certain values exist in the tree and print the result
...
print()
print("Visual represntation of my_tree:\n")
my_tree.print_tree_visual(my_tree.root)
